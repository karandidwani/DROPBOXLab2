...
app.post('/login', function(req, res) {
    console.log("in post method of login");
...
app.post('/register', function(req, res){
    ...
    console.log("1) In post method of /register ");
    console.log("2) values fetched are i-"+firstname+" ii-"+lastname+" iii-"+username+" iv-"+password);
